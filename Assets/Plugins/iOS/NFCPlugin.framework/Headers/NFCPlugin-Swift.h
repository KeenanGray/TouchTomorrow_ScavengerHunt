...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NFCPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9NFCPlugin9NFCReader")
...
- (void)beginSession;
- (NSString * _Nonnull)getNFCString SWIFT_WARN_UNUSED_RESULT;
